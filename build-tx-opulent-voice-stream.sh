...
arm-linux-gnueabihf-gcc -mfloat-abi=hard --sysroot=$HOME/pluto-0.38.sysroot -g -D STREAMING -D RF_LOOPBACK -o bin/msk_opv-stream opulent_voice.c -lpthread -liio -lm -Wall -Wextra -Wl,-z,stack-size=32768
