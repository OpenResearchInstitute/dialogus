...
/*
 * msk_tx PRBS transmit test code
 *
...
//include RDF generated header for register map
...
//        write_dma(msk_virtual_addr, PRBS_ERROR_MASK, 0x00000000);
	...
	//printf("percent error for this segment: (%2.1f)\n", ((double)(read_dma(msk_virtual_addr, PRBS_ERROR_COUNT))/(double)(read_dma(msk_virtual_addr, PRBS_BIT_COUNT)))*100);
