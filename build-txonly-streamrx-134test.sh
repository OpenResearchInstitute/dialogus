...
arm-linux-gnueabihf-gcc -mfloat-abi=hard --sysroot=$HOME/pluto-0.38.sysroot -g -D STREAMING -D STREAM_RX_IN_THREAD -D NO_INIT_ON_SUCCESS -D RF_LOOPBACK -o msk_134test-xmit opulent_voice.c -lpthread -liio -lm -Wall -Wextra
