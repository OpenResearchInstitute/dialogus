...
arm-linux-gnueabihf-gcc -mfloat-abi=hard --sysroot=$HOME/pluto-0.38.sysroot -g -o bin/dialogus dialogus.c registers.c statistics.c debugthread.c timestamp.c debug_utils.c receiver.c randomizer.c fec.c interleaver.c  -lpthread -liio -lm -Wall -Wextra
