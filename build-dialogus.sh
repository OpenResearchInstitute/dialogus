...
arm-linux-gnueabihf-gcc -mfloat-abi=hard --sysroot=$HOME/pluto-0.38.sysroot -g -o dialogus dialogus.c registers.c statistics.c debugthread.c timestamp.c -lpthread -liio -lm -Wall -Wextra
