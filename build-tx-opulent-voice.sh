...
arm-linux-gnueabihf-gcc -mfloat-abi=hard --sysroot=$HOME/pluto-0.38.sysroot -g -D OVP_FRAME_MODE -o bin/msk_opv-xmit opulent_voice.c -lpthread -liio -lm -Wall -Wextra -Wl,-z,stack-size=32768
